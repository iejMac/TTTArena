...
test = Test("trained_model_0_1", "trained_opt_state_0_1", 10) 
...
# test.compare_model(None, None, games_per_side=40, num_simulations=100, render=1, alpha=0.1)
test.compare_model("trained_model_0_2", "trained_opt_state_0_2", games_per_side=40, num_simulations=100, render=10, alpha=0.1)
