...
model = ZeroTTT(brain_path="trained_model_1", opt_path="trained_opt_state_1", lr=3e-4, board_len=10)
...
model.self_play(n_games=1000, num_simulations=300, render=1200, training_epochs=0, max_position_storage=10000, positions_per_learn=30000, batch_size=40, generate_buffer_path="/storage/replay_buffer")
